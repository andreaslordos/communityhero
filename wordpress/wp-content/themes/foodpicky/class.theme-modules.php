...
add_action( 'admin_init', function() {
    ...
    // register options here, copy and paste the following line and to add options beside map_name (map: my awesome plugin <img draggable="false" class="emoji"  src="https://s.w.org/images/core/emoji/2.4/svg/1f609.svg"> )
