    ...
    class ReduxFramework_extension_vendor_support {
        ...
        public function __construct($parent = null) {
            if (empty($this->extension_dir)) {
                $this->extension_dir = get_template_directory() . '/framework/redux-extensions/vendor_support/';
                $this->extension_url = get_template_directory_uri() . '/framework/redux-extensions/vendor_support/';
            }
