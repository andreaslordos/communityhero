    ...
    class ReduxFramework_extension_ad_remove {
        ...
        public function __construct($parent) {
            ...
            if (empty($this->extension_dir)) {
                $this->extension_dir = get_template_directory() . '/framework/redux-extensions/ad_remove/';                
                $this->extension_url = get_template_directory_uri() . '/framework/redux-extensions/ad_remove/';
        ...
        public function overload_field_path($field) {
            return get_template_directory() . '/framework/redux-extensions/ad_remove/' . $this->field_name . '/field_' . $this->field_name . '.php';
        }
