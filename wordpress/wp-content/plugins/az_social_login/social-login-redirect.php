...
<html>
    <head>
        <title><?php esc_html_e('Redirecting...', 'azsl') ?></title>
    ...
    <body>
        ...
        <h2><?php esc_html_e('Please close this window to continue.', 'azsl') ?></h2>
        <script>
            window.onbeforeunload = function() {
                document.getElementsByTagName('h2')[0].innerHTML = "<?php esc_html_e('Redirecting, please wait', 'azsl') ?>";
            }
        </script>
        <script src="<?php print get_template_directory_uri() . '/js/hello.all.min.js' ?>"></script>
    </body>
</html>
