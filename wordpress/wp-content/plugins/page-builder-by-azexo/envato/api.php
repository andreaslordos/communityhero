 ...
 */
if (!class_exists('AZEXO_Envato_Market_API')) :

    /**
     * Creates the Envato API connection.
     *
     * @class AZEXO_Envato_Market_API
     * @version 1.0.0
     * @since 1.0.0
     */
    class AZEXO_Envato_Market_API {
        ...
        /**
         * Main AZEXO_Envato_Market_API Instance
         *
         * Ensures only one instance of this class exists in memory at any one time.
         *
         * @see AZEXO_Envato_Market_API()
         * @uses AZEXO_Envato_Market_API::init_globals() Setup class globals.
         * @uses AZEXO_Envato_Market_API::init_actions() Setup hooks and actions.
         *
         * @since 1.0.0
         * @static
         * @return object The one true AZEXO_Envato_Market_API.
         * @codeCoverageIgnore
         */
         ...
         *
         * @see AZEXO_Envato_Market_API::instance()
         *
         * @since 1.0.0
         * @access private
         * @codeCoverageIgnore
        ...
        private function init_globals() {
            // Envato API token.
            $this->token = azexo_envato_market_token();
        }
        ...
        public function request($url, $args = array()) {
            $defaults = array(
                'headers' => array(
                    ...
                    'User-Agent' => 'WordPress - Envato Market 1.0.0',
                ),
                'timeout' => 20,
            );
        ...
        public function deferred_download($id) {
            ...
            return add_query_arg($args, esc_url(azexo_updater_page_url()));
        }
